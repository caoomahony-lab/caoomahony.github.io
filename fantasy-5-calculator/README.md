...
- D-space batch coverage with a top-level coverage score, best-found same-size reference, and D–G plot;
- population-weighted D–G mode using exact legal-set density for Fantasy 5, Powerball, and Mega Millions, with one-to-one baseline matching;\n- fail-closed input validation and responsive desktop/mobile layout.
